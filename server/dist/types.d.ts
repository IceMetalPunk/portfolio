...
export type YTSnippet = YTUploadSnippet | YTSubscriptionSnippet | YTVideoSnippet;
...
export type YTResultsGenerator<T extends YTSnippet> = AsyncGenerator<YTResultItem<T>, void, void>;
